...
class MakeMask:
    ...
    def convolved_masks(self):
        ...
        self.u_masks_conv = np.array(dilate_masks(self.u_masks, kernel)) > 0
        self.l_masks_conv = np.array(dilate_masks(self.l_masks, kernel)) > 0
        self.all_masks = (self.u_masks_conv + self.l_masks_conv) > 0
